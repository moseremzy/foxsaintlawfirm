...
const AboutData = () => {
  return (
    <div className='w-full bg-white h-full px-5 py-16 md:px-10 flex flex-col md:flex-row items-center justify-around gap-2 md:gap-10'>
      {aboutData.map((item, index) => (
        <section key={index} className="mb-10 flex flex-col">
