...
const Newsbar = () => {
  ...
  return (
    <div className="sticky top-[60px] lg:top-[80px] z-40 bg-gradient-to-r from-blue-800 to-blue-950 h-16 w-full flex items-center justify-center overflow-hidden">
      <div
